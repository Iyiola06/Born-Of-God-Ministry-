...
export function SearchBar() {
  ...
  return (
    <div className="relative w-full group">
      ...
      <div className={`relative flex items-center bg-black/40 border backdrop-blur-2xl rounded-2xl transition-all duration-300 ${isFocused ? 'border-white/30 shadow-[0_0_30px_rgba(255,255,255,0.1)]' : 'border-white/10 shadow-lg'}`}>
        ...
        <div className="pr-4 pl-2 py-2">
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all ${showFilters ? 'bg-white text-black' : 'bg-white/5 text-white/70 hover:bg-white/10 hover:text-white'}`}
          >
